...
export const Profile: React.FC<ProfileProps> = ({ userProfile, onUpdateProfile }) => {
    ...
    }, [isEditing, formData.weightUnit, userProfile, displayCurrentWeight, displayGoalWeight]);

...
import { Camera, UtensilsCrossed, Users, Heart } from 'lucide-react';
       ...
       <div className="mt-12">
            ...
            {!loading && (
                ...
                {featuredRecipes.map(recipe => {
                    const id = recipe.url || '';
                    return (
                    <div key={id} onClick={() => setSelectedRecipe(recipe)} className="group bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden transition-transform transform hover:-translate-y-1 flex flex-col cursor-pointer">
